...
ggsave(glue("interpretable-{subsample}.png"))
```

To run across all sample sizes, use this command:

```
for (i in c(500, 1000, 5000, 10000)) { rmarkdown::render(glue::glue("estimate/interpretable-{i}.Rmd"), knit_root_dir="../"); }
```