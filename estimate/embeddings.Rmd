...
endpoints <- embeddings |>
  mutate(id = row_number()) |>
  #filter(id %in% c(110, 296)) |> # 284 -> 218 in tax128 also interesting
  #filter(id %in% c(233, 15)) |> # 284 -> 218 in tax128 also interesting
...
ggsave("data/species_interpolation.png", width = 12, height = 4)
```
